                    ...
                    <div class="col-md-auto hidden-md-down pl-3">
                        ...
                        <div class="header-first clearfix">
                            ...
                            <div id="logo" class="logo">
                                <a href="index.html"><img id="logo_img" src="<?= base_url("assets/images"); ?>/logo_blue.png" alt="The Project"></a>
                            </div>
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-brand clearfix hidden-lg-up">
                                        ...
                                        <div id="logo-mobile" class="logo">
                                            <a href="index.html"><img id="logo-img-mobile" src="<?= base_url("assets/images"); ?>/logo_blue.png" alt="The Project"></a>
                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-3 hidden-md-down">
                                                                ...
                                                                <img src="<?= base_url("assets/images"); ?>/section-image-3.png" alt="The Project">
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                ...
                <div id="slider-banner-fullwidth-big-height" class="slider-banner-fullwidth-big-height rev_slider" data-version="5.0">
                    <ul class="slides">
                        ...
                        <li data-transition="fadefromright" data-slotamount="default" data-masterspeed="default" data-title="We Can Build Anything">
                            ...
                            <!-- main image -->
                            <img src="<?= base_url("assets/images"); ?>/construction-slider-slide-1.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                        ...
                        <li data-transition="fadefromright" data-slotamount="default" data-masterspeed="default" data-title="Make your Dreams Come True">
                            ...
                            <!-- main image -->
                            <img src="<?= base_url("assets/images"); ?>/construction-slider-slide-2.jpg" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                        ...
                        <div class="col-lg-6">
                            <div class="owl-carousel content-slider-with-controls">
                                <div class="overlay-container overlay-visible">
                                    <img src="<?= base_url("assets/images"); ?>/construction-1.jpg" alt="">
                                    <div class="overlay-bottom hidden-sm-down">
                                        <div class="text">
                                            <h3 class="title">We Create You Enjoy</h3>
                                        </div>
                                    </div>
                                    <a href="<?= base_url("assets/images"); ?>/construction-1.jpg" class="owl-carousel--popup-img overlay-link" title="image title"><i class="icon-plus-1"></i></a>
                                </div>
                                <div class="overlay-container overlay-visible">
                                    <img src="<?= base_url("assets/images"); ?>/construction-2.jpg" alt="">
                                    <div class="overlay-bottom hidden-sm-down">
                                        <div class="text">
                                            <h3 class="title">You Can Trust Us</h3>
                                        </div>
                                    </div>
                                    <a href="<?= base_url("assets/images"); ?>/construction-2.jpg" class="owl-carousel--popup-img overlay-link" title="image title"><i class="icon-plus-1"></i></a>
                                </div>
                                <div class="overlay-container overlay-visible">
                                    <img src="<?= base_url("assets/images"); ?>/construction-3.jpg" alt="">
                                    <div class="overlay-bottom hidden-sm-down">
                                        <div class="text">
                                            <h3 class="title">We Love What We Do</h3>
                                        </div>
                                    </div>
                                    <a href="<?= base_url("assets/images"); ?>/construction-3.jpg" class="owl-carousel--popup-img overlay-link" title="image title"><i class="icon-plus-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="image-box style-2 mb-20">
                        <div class="overlay-container overlay-visible">
                            <img src="<?= base_url("assets/images"); ?>/construction-service-1.jpg" alt="">
                ...
                <div class="col-md-4">
                    <div class="image-box style-2 mb-20">
                        <div class="overlay-container overlay-visible">
                            <img src="<?= base_url("assets/images"); ?>/construction-service-2.jpg" alt="">
                            <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                            <div class="overlay-bottom">
                                <div class="text">
                ...
                <div class="col-md-4">
                    <div class="image-box style-2 mb-20">
                        <div class="overlay-container overlay-visible">
                            <img src="<?= base_url("assets/images"); ?>/construction-service-3.jpg" alt="">
                            <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                            <div class="overlay-bottom">
                                <div class="text">
                    ...
                    <div class="process">
                        ...
                        <div class="tab-content clear-style">
                            ...
                            <div class="tab-pane" id="pill-pr-2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <img src="<?= base_url("assets/images"); ?>/section-image-3.jpg" alt="">
                                    </div>
                                    <div class="col-lg-6">
                ...
                <div class="col-12">
                    ...
                    <div class="isotope-container row grid-space-10">
                            ...
                            <div id="carousel-portfolio" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <div class="image-box shadow bordered text-center mb-20">
                                            <div class="overlay-container">
                                                <img src="<?= base_url("assets/images"); ?>/construction-portfolio-1.jpg" alt="">
                                    ...
                                    <div class="carousel-item">
                                        <div class="image-box shadow bordered text-center mb-20">
                                            <div class="overlay-container">
                                                <img src="<?= base_url("assets/images"); ?>/construction-portfolio-1-2.jpg" alt="">
                                                <div class="overlay-top">
                                                    <div class="text">
                                                        <h3><a href="portfolio-item.html">Project Title</a></h3>
                                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="image-box shadow bordered text-center mb-20">
                                            <div class="overlay-container">
                                                <img src="<?= base_url("assets/images"); ?>/construction-portfolio-1-3.jpg" alt="">
                                                <div class="overlay-top">
                                                    <div class="text">
                                                        <h3><a href="portfolio-item.html">Project Title</a></h3>
                                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item construction-management">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-2.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item construction-management">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-3.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item interior-design">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-4.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item architecture-plans">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-5.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item construction-management">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-6.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item architecture-plans">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-7.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 isotope-item interior-design">
                            <div class="image-box shadow bordered text-center mb-20">
                                <div class="overlay-container">
                                    <img src="<?= base_url("assets/images"); ?>/construction-portfolio-8.jpg" alt="">
                                    <div class="overlay-top">
                                        <div class="text">
                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="testimonial text-center">
                            <div class="testimonial-image">
                                <img src="<?= base_url("assets/images"); ?>/testimonial-1.jpg" alt="Jane Doe" title="Jane Doe" class="rounded-circle">
                            </div>
                            <h3>Just Perfect!</h3>
                            <div class="separator"></div>
            ...
            <div class="container">
                <div class="row justify-content-lg-center">
                    <div class="col-lg-8">
                        <div class="testimonial text-center">
                            <div class="testimonial-image">
                                <img src="<?= base_url("assets/images"); ?>/testimonial-2.jpg" alt="Jane Doe" title="Jane Doe" class="rounded-circle">
                            </div>
                            <h3>Amazing!</h3>
                            <div class="separator"></div>
                            <div class="testimonial-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="footer-content">
                                <div class="logo-footer"><img id="logo-footer" src="<?= base_url("assets/images"); ?>/logo_blue.png" alt=""></div>
