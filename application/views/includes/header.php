                ...
                <div class="col-md-2 ">
                    ...
                    <div class="header-first clearfix">
                        ...
                        <div id="logo" class="logo">
                            <a href="index.html"><img id="logo_img" src="<?= base_url("assets"); ?>/images/logo_purple.png" alt="The Project"></a>
                        </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                        ...
                                        <ul class="nav navbar-nav ">
                                            ...
                                            <li class="active">
                                                <a href="portfolio-grid-2-3-col.html">Anasayfa</a>
                                            </li>
                                            ...
                                            <li class="dropdown ">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li ><a href="portfolio-list-1.html">Resim Galerileri</a></li>
                                                    <li ><a href="portfolio-list-2.html">Video Galerileri</a></li>
                                                    <li ><a href="portfolio-list-sidebar.html">Dosya Galerileri</a></li>
                                                </ul>
                                            </li>

                                            <li>
                                                <a href="portfolio-grid-2-3-col.html">Ürünler</a>
                                            </li>
                                            <li>
