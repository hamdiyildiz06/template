                            ...
                            <?php if (($index % 2) == 0){ ?>
                                <div class="col-md-6">
                                    <div class="overlay-container">
                                        <img src="<?= base_url("panel/uploads/services_v/{$service->img_url}"); ?>" alt="<?= $service->title; ?>">
                                        <div class="overlay-to-top">
                                            <p class="small margin-clear"><em><?= $service->title; ?></em></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="body">
                                        ...
                                        <h3><?= $service->title; ?></h3>
                                        <div class="separator-2"></div>
                                        <p class="margin-clear"><?= character_limiter(strip_tags($service->description), 200); ?></p>
                                        <br>
